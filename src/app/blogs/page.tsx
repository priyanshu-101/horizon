...
import {
  ...
  BlogCategorySection,
  RecentBlogsSection,
} from '@/components/sections/Blogs';
import FooterSection from '@/components/sections/AboutUs/FooterSection';

// Constants
const MOBILE_BREAKPOINT = 768;
const MOBILE_BORDER_RADIUS = '20px';
const MOBILE_MARGIN = '10px';
const MOBILE_MAX_WIDTH = 'calc(100vw - 20px)';
...
function BlogsPage() {
  ...
  // Mobile detection - only runs after hydration to prevent SSR mismatch
  useEffect(() => {
    ...
    const checkMobile = () => {
      try {
        ...
        // Fallback to desktop view on error - could be logged to monitoring service in production
        setIsMobile(false);
      }
    };
  ...
  return (
    <div
      ...
      style={{
        backgroundColor: '#F2F4F6',
        minHeight: '100vh',
        borderRadius: isMobile ? MOBILE_BORDER_RADIUS : '0',
        overflow: isMobile ? 'hidden' : 'visible',
        margin: isMobile ? MOBILE_MARGIN : '0',
        maxWidth: isMobile ? MOBILE_MAX_WIDTH : '100%',
          ...
          {isMobileMenuOpen && (
            <div className='lg:hidden bg-white border-t border-gray-200'>
              <div className='px-4 py-4 space-y-4'>
                ...
                <a href='/blogs' className='block text-orange-500 font-medium'>
                  Blogs
                </a>
